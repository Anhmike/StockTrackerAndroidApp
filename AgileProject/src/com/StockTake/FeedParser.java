...
public class FeedParser {
	...
	public BufferedReader getCsvHistoric(String stockSymbol) {
		...
		int day = cal.get(Calendar.DAY_OF_MONTH) - 4; // sets starting date to 4
														// days ago
		...
		InputStream is = null;
		try {
			feedUrl = new URL("http://ichart.finance.yahoo.com/table.csv?s="
					+ stockSymbol + ".L&a=" + month + "&b=" + day + "&c=2014");
		} catch (IOException e) {
	...
	private String[] parseCsvString(BufferedReader csvToParse)
			throws IOException {
		String strLine = "";
